      ...
      <section>
        ...
        <div className="items-center space-y-2 xl:grid xl:grid-cols-3 xl:gap-x-8 xl:space-y-2 ">
          ...
          <div className="pt-8 pb-8 prose dark:prose-dark max-w-none xl:col-span-2">
            <p>
              I'm Khaled Bahabri (@Khaledbuilds) a Mechatronics Engineer, ML/AI and a Blockchain Enthusiast. I have been building & shipping tech solutions around the globe,
